...
function updateLivePreview() {
	...
	gravatar += 's=50';
    		...
    		gravatar += '&amp;r=G';
		    document.getElementById('commentPreview').innerHTML = '<ol class="commentlist">			<li class="alt" id="comment-lcp">			<img alt=\'\' src=\'' + gravatar + '\' class=\'avatar avatar-50 photo avatar-default\' height=\'50\' width=\'50\' />					<span class="auth-name">' + name + '</span><br />					<span class="auth-time">					August 18th, 2014 @ 2:24 pm 							<div class="commenttext">					<p>' + cmnt + '</p>					</div>										</li>			</ol>';
}
